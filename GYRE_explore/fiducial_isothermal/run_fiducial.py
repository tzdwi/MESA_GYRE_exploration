...
if __name__ == "__main__":
    ...
    #profiles = np.arange(*profile_min_max,15,dtype=int) excited for 61 and 76...
    #profiles = np.arange(*profile_min_max,5,dtype=int) Whoa, a new mode around 86! 
    profiles = np.arange(51,91) #Now the rest!
